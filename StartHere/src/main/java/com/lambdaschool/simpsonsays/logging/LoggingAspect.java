package com.lambdaschool.simpsonsays.logging;
...
{
    @Around(value = "@within(com.lambdaschool.simpsonsays.logging.Loggable) || @annotation(com.lambdaschool.simpsonsays.logging.Loggable)")
